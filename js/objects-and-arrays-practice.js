...
function removeDuplicates(value) {
    ...
    for (let i = 0; i < value.length; i++) {
        if(uniqueString.includes(value[i])) {
        } else {
            uniqueString.push(value[i])
        }
    }
    return uniqueString;
}
...
console.log(numberInfo(5));
console.log(numberInfo(-25));
console.log(numberInfo(4));
console.log(numberInfo(-16));